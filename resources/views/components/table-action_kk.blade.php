...
<div>
    {{ $slot }}
    <!-- <button wire:click="$emitTo('admin.keluarga-table', 'showData', {{ $iddata }})" class="btn btn-sm btn-primary mb-1 text-white" style="width:20px; height:20px; border-radius: 50%; padding: 0px;">
